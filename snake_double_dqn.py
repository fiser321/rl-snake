...
class DoubleDqn(object):
    ...
    def createNetwork(self,c_names, train_able = False):
        # network weights
        ...
        W_fc1 = self.weight_variable([1600, 512], c_names, name="wf1")
        ...
        if train_able:
            ...
            self.s_ = tf.placeholder("float", [None, 80, 80, 4])
            s = self.s_
    ...
    def train_net(self):
        ...
        with tf.variable_scope('eval_net'):
            ...
            s, self.q_eval, h_fc1 = self.createNetwork(c_names=c_names, train_able=True,)
        ...
        with tf.variable_scope('target_net'):
            ...
            s_, self.q_next, h_fc1_ = self.createNetwork(c_names=c_names, train_able=False)
